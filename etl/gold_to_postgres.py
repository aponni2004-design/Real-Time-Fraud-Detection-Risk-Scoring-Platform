...
# =========================================================
# 10. KEEP ONLY NEW GOLD TRANSACTIONS
# =========================================================
...
print("New transactions to load:", new_gold_count)
...
print(
    "NULL customer keys:",
    fact_df.filter(col("customer_key").isNull()).count()
)

print(
    "NULL merchant keys:",
    fact_df.filter(col("merchant_key").isNull()).count()
)

print(
    "NULL device keys:",
    fact_df.filter(col("device_key").isNull()).count()
)

print(
    "NULL date keys:",
    fact_df.filter(col("date_key").isNull()).count()
)
...
print("New fact transactions:", fact_count)
